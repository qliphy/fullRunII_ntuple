...
config.General.requestName   = 'singleElectron-18A-v1_new'
...
config.Data.inputDataset = '/SingleElectron/Run2018A-17Sep2018-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'singleElectron-18A-v1_new'
