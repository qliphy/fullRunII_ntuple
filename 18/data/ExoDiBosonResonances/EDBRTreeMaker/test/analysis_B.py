...
if runOnMC:
   ...
   jecLevelsAK8chs = [
                                   'Autumn18_RunB_V8_DATA_L1FastJet_AK8PFchs.txt',
                                   'Autumn18_RunB_V8_DATA_L2Relative_AK8PFchs.txt',
                                   'Autumn18_RunB_V8_DATA_L3Absolute_AK8PFchs.txt',
                                   'Autumn18_RunB_V8_DATA_L2L3Residual_AK8PFchs.txt'
     ]
   jecLevelsAK8chsGroomed = [
                                   'Autumn18_RunB_V8_DATA_L2Relative_AK8PFchs.txt',
                                   'Autumn18_RunB_V8_DATA_L3Absolute_AK8PFchs.txt',
   ...
   jecLevelsAK8puppi = [
                                   'Autumn18_RunB_V8_DATA_L1FastJet_AK8PFPuppi.txt',
                                   'Autumn18_RunB_V8_DATA_L2Relative_AK8PFPuppi.txt',
                                   'Autumn18_RunB_V8_DATA_L3Absolute_AK8PFPuppi.txt',
                                   'Autumn18_RunB_V8_DATA_L2L3Residual_AK8PFPuppi.txt'
     ]
   jecLevelsAK8puppiGroomed = [
                                   'Autumn18_RunB_V8_DATA_L2Relative_AK8PFPuppi.txt',
                                   'Autumn18_RunB_V8_DATA_L3Absolute_AK8PFPuppi.txt',
