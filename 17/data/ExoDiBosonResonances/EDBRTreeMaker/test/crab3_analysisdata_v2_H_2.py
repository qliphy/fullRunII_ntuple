...
config.General.requestName   = 'singleMuon-16H-v2_new'
...
config.Data.inputDataset = '/SingleMuon/Run2016H-03Feb2017_ver3-v1/MINIAOD'#Run2015D-PromptReco-v3/MINIAOD'
...
config.Data.outputDatasetTag = 'singleMuon-16H-v2_new'
