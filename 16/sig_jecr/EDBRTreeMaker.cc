    ...
    if((hadronicVs->size()!= 0 )  && (leptonicVs->size()!= 0) ){
       ...
       iEvent.getByToken(vtxToken_, vertices);
        ...
        if( doPuppi ){//1
            ...
            ghadronicVpuppi_2_JEC_up.SetPtEtaPhiE(jetAK8puppi_ptJEC_2_JEC_up, jetAK8puppi_eta_2, jetAK8puppi_phi_2, jetAK8puppi_e_2_JEC_up);
            ...
            ghadronicVpuppi_2_JEC_down.SetPtEtaPhiE(jetAK8puppi_ptJEC_2_JEC_down, jetAK8puppi_eta_2, jetAK8puppi_phi_2, jetAK8puppi_e_2_JEC_down);
