...
config.General.requestName   = 'singleElectron-16H-v2_new_new'
...
config.Data.inputDataset = '/SingleElectron/Run2016H-03Feb2017_ver3-v1/MINIAOD'#Run2015D-PromptReco-v3/MINIAOD'
...
config.Data.outputDatasetTag = 'singleElectron-16H-v2_new_new'
