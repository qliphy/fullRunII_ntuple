...
config.General.requestName   = 'singleElectron-16H-v1_new_new'
...
config.Data.inputDataset = '/SingleElectron/Run2016H-03Feb2017_ver2-v1/MINIAOD'#Run2015D-PromptReco-v3/MINIAOD'
...
config.Data.outputDatasetTag = 'singleElectron-16H-v1_new_new'
