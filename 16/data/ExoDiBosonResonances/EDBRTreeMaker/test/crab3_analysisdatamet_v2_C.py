...
config.General.requestName   = 'MET-16C-v1_new_new'
...
config.Data.inputDataset = '/MET/Run2016C-03Feb2017-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'MET-16C-v1_new_new'
